...
def add_const_string():
    ...
    if  const_string < 30000:
        const_string += 1
        return const_string
    else: 
        raise Exception("ERROR: No hay memoria disponible para Letreros Constantes")  
...
def crear_direccion(return_type, func_name, constante, temporal): 
  if return_type == 1:
    if constante: 
